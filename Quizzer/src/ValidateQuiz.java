...
/**
 * Servlet implementation class ValidateQuiz
 */
@WebServlet("/ValidateQuiz")
public class ValidateQuiz extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(answer.equalsIgnoreCase(option)){
			...
			response.sendRedirect("Result.jsp?answer=wrong");
		}
	}
